...
Nella Tabella~\ref{Tab.2} sono riportati i risultati ottenuti eseguendo CPLEX, l'euristica greedy veloce, l'euristica di scambio e l'euristica lagrangiana sulle istanze con riduzione del numero di sprint (nSprint - 2). Per ogni algoritmo.
