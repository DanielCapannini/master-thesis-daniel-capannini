...
\section{Aggiornamenti ai metodi di cutting plane}
...
\begin{description}
    ...
    \item[\textbf{Avg.S.U. (\%)}] \emph{Media Utilizzo Sprint}: percentuale media di capacità $c_i$ effettivamente sfruttata negli sprint occupati:
    \[
    \text{Avg.S.U.} = \frac{100}{|\{i : \exists j, x_{ij} = 1\}|} \sum_{i : \exists j, x_{ij} = 1} \frac{\sum_j p_j x_{ij}}{c_i}
    \]
...
\begin{description}
    \item[\textbf{Dev.Risk}] \emph{Deviazione Standard del Rischio}: quantifica la variabilità del rischio medio aggregato $\bar{r}_i^{cr} = \frac{1}{|\{j : x_{ij}=1\}|} \sum_j r_j^{cr} x_{ij}$ tra gli sprint occupati:
    \[
    \text{Dev.Risk} = \sqrt{\frac{1}{|\{i : \exists j, x_{ij} = 1\}|} \sum_{i : \exists j, x_{ij} = 1} (\bar{r}_i^{cr} - \bar{r}^{cr})^2}
    \]
    ...
    \item[\textbf{Dev.Unc.}] \emph{Deviazione Standard dell'Incertezza}: analoga a Dev.Risk, misura la variabilità dell'incertezza media $\bar{r}_i^{unc}$ tra gli sprint. Bassa variabilità favorisce gestione prevedibile e uniforme delle attività ad alta incertezza, evitando sprint particolarmente volatili.
    
    \item[\textbf{Min.Risk}] \emph{Rischio Minimo}: identifica il valore minimo di $\bar{r}_i^{cr}$ tra tutti gli sprint occupati. Valori troppo bassi possono segnalare sprint composti esclusivamente da user story ``sicure'', indicando potenziale sottoutilizzo delle capacità del team di gestire attività complesse.
    
    \item[\textbf{Max.Risk}] \emph{Rischio Massimo}: identifica il valore massimo di $\bar{r}_i^{cr}$ tra tutti gli sprint occupati. Valori eccessivamente elevati segnalano sprint critici con esposizione al rischio potenzialmente ingestibile, che richiedono attenzione particolare dal team e dagli stakeholder.
    
    \item[\textbf{Min.Unc.}] \emph{Incertezza Minima}: valore minimo di $\bar{r}_i^{unc}$ tra gli sprint occupati. Garantisce che ogni sprint contenga user story con un livello minimo di incertezza, evitando sprint composti solo da attività banali o completamente comprese.
    
    \item[\textbf{Max.Unc.}] \emph{Incertezza Massima}: valore massimo di $\bar{r}_i^{unc}$ tra gli sprint occupati. Identifica l'esposizione all'incertezza nel caso peggiore, essenziale per valutare la robustezza della pianificazione rispetto a imprevisti e variazioni nelle stime.
\end{description}

\paragraph{Progressione del valore consegnato.}

\begin{description}
    \item[\textbf{Half.U.S.}] \emph{Half Utility Sprint}: indice dello sprint in cui viene raggiunto almeno il 50\% dell'utilità totale cumulata:
    \[
    \text{Half.U.S.} = \min \left\{ k : \sum_{i=1}^{k} \sum_{j=1}^{n} u_j x_{ij} \geq \frac{1}{2} \sum_{j=1}^{n} u_j \right\}
    \]
...
\small
\resizebox{\textwidth}{!}{%
\begin{tabular}{|ll|rrrrrrrrr|rrrrrrrrr|rrrrrrrrr|} 
\hline
...
