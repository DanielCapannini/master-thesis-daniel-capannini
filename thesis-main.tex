...
Le procedure di riduzione mirano a rafforzare i vincoli di capacità \eqref{Eq1.P2} modificando le capacità degli sprint o i pesi \( pr_j = p_j r_j^{un} \) delle user story. Approcci simili sono utilizzati per problemi di packing in \parencite{BHM02,BM03a,BM10}.
...
Abbiamo indagato in particolare le classiche \emph{Lifted Cover Inequalities} (LCI), corrispondenti ai vincoli di capacità \eqref{Eq1.P2}, come suggerito dalla letteratura su problemi simili (si veda ad esempio \parencite{ABV10}).
...
In \parencite{BOSCHETTI2014116} sono state proposte due euristiche greedy per costruire un piano di sprint  e una procedura di post ottimizzazione basata su scambi locali. In questa sezione ne riprendiamo brevemente il funzionamento, poiché tali euristiche costituiscono la base anche per il lavoro sviluppato in questa tesi.
...
In \parencite{BOSCHETTI2014116} viene proposta \emph{ExchangeHeuristic} descritta in Figura~\ref{Alg.EH}. Data una soluzione $\mathbf{x}'$ da migliorare, la procedura tenta sistematicamente di scambiare user story tra coppie di sprint, ripetendo il processo fino a quando avviene almeno uno scambio migliorativo. In particolare, {\em ExchangeHeuristic} considera tre tipi di mosse:
\begin{description}
...
\subsection{Formulazioni matematiche}
...
I seguenti indicatori, già utilizzati in~\parencite{BOSCHETTI2014116}, permettono di confrontare le prestazioni algoritmiche e la convergenza verso l'ottimalità:
...
Nella Tabella~\ref{Tab.2} sono riportati i risultati ottenuti dall'esecuzione degli algoritmi proposti  da \parencite{BOSCHETTI2014116} con l'aggiornamento del codice per supportare l'attuale versione della libreria CPLEX.
...
\subsection{funzuone obbiettovo \eqref{Eq2.P1}}
...
\subsection{Funzione obbiettivo \eqref{Eq2.P2} e \eqref{Eq2.P3}}
...
\subsection{Funzione obbiettivo \eqref{Eq2.P4} e \eqref{Eq2.P5}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/tempoFO.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/POSFO.png}
    \caption{Tempo di calcolo per le diverse funzioni obbiettivo}
    \label{fig:POSFO}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/dr1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/rmax1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/du1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/umax1.png}
