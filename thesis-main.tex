...
Per quanto riguarda i KPI delle due funzioni obiettivo si possono notare delle differenze minime, tra le tabelle \ref{tab.new2} e \ref{tab.new03} si possono notare che vi sono alcune istanze per cui i KPI N.U.S. e H.U.S. risultano inferiri per le istanze delle funzione obiettivo \eqref{Eq2.P1}, perciò questo indica che anticipare se possibile la risoluzione dei vincoli porta poi successivamente a velocizzare il progetto.
...
Al contrario di quello che si e' notato nel confronto tra le funzioni obiettivo \eqref{Eq1.P1} e \eqref{Eq2.P1}, in questo caso il confronto dei KPI N.U.S. e H.U.S. tra le due funzioni obiettivo risulta risulta per alcune istanze favorevole alla funzione obiettivo \eqref{Eq2.P2} che risulta riuscire a concludere le istanze con un numero leggermente minore di sprint rispetto alla funzione obiettivo \eqref{Eq2.P3}.
...
Si puo pero notare una variazione nei tempi di calcolo, per il metodo esatto la riduzione del numero di sprint porta un risparmio del $61.01\%$ di tempo di calcolo, mentre per il metodo euristico del $117.54\%$ e per il metodo euristico Lagrangiano del $162.14\%$. Da quest'ultima considerazione si può notare come la riduzione del numero di sprint a disposizione porta a una diminuzione dei tempi di calcolo. 
...
Il KPI N.U.S. e' aumentato del $26.59\%$ per il metodo esatto e del $25.08\%$ per i metodi euristici, mentre per il KPI H.U.S. vi e' stato un aumento del $26.67\%$ per il metodo esatto e del $15.51\%$ per i metodi euristici. Questo indicando come era presumibile che la riduzione della capacità degli sprint ha portato ad un aumento del numero degli sprint necessari a completare il progetto.
